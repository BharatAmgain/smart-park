...
INSTALLED_APPS = [
    ...
    'channels',
    'parking_app',
    'django_apscheduler',          # for background reminders
    'allauth',
    'allauth.account',
...
MIDDLEWARE = [
    ...
    'parking_app.middleware.DisableCSRFForAPIMiddleware',   # custom middleware
...
EMAIL_HOST_PASSWORD = 'qyqb pfde frfm oznj'   # App password
OTP_EXPIRY_SECONDS = 300

# ========== eSewa Payment Gateway ==========
ESEWA_MERCHANT_CODE = 'EPAYTEST'
ESEWA_SECRET_KEY = '8gBm/:&EnhH.1/q'   # Note the slash is not a typo
...
# ========== Firebase Admin SDK (optional – leave if not used) ==========
FIREBASE_ADMIN_CREDENTIALS_PATH = os.path.join(BASE_DIR, 'firebase-key.json')

# ========== Fix for PickleSerializer error ==========
...
# Allauth settings (compatible with latest allauth)
